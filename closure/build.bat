...
set csrj=%%externs%% %%jss%% --define WORKER_PATH='' --define CORS=%%cors%% --js_output_file %src%\index.js
echo csrj=csr %csrj%
...
set csrj3=%%externs%% %%jss3%% --define CORS=%%cors%% --define FOROUTPUT --js_output_file %src%\sw.js
